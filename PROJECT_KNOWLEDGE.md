...
| **npm Package** | [mnehmos.ooda.mcp](https://www.npmjs.com/package/mnehmos.ooda.mcp) |
...
├── .github/
│   └── workflows/
│       ├── ci.yml               # Build/test matrix (Node 18/20/22 × OS)
│       └── publish.yml          # npm publish on GitHub release (OIDC)
├── src/
│   ├── index.ts                 # MCP server entry point, tool registration
│   ├── config.ts                # Configuration file loading and validation
│   ├── audit.ts                 # Audit logging for tool execution tracking
│   ├── constants.ts             # Centralized timeout and limit constants
│   ├── storage/
...
*Last Updated: 2026-01-10 | v1.0.0 Production Release*
*Source: https://github.com/Mnehmos/mnehmos.ooda.mcp*
*npm: https://www.npmjs.com/package/mnehmos.ooda.mcp*
